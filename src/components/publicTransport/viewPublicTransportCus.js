...
export default function ViewPublicTransportDetailsCus(props) {
    ...
    <View style={styles.centeredView}>
        ...
        <View style={{ marginTop: 10 }} >
                    ...
                    {/* Fuel station Loaction  */}
                       ...
                       <Text style={styles.name2}>RouteNo : </Text>
  
                       <Text style={styles.name3}>{routeNo}</Text>
                          </View>
                     ...
                     <Text style={styles.name2}>Route : </Text>

                     <Text style={styles.name3}>{route}</Text>
                        </View>

                        {/* description */}
                        <View style={styles.time1}>
                       
                       <Text style={styles.name2}>Discription : </Text>
  
                       <Text style={styles.name3}>{discription}</Text>
                          </View>
