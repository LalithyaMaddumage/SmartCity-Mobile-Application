...
import { getPublicTransport } from '../../../services/publicTransportService';
import UpdatePublicTransportDetails from './updatePublicTransport';
...
export default function ViewPublicTransportDetails() {
...
const List = () => {
    ...
    <View style={[styles.itemList, styles.elevation]}>
        ...
        <Text style={styles.titleID}>{element.routeNo}</Text>
        {/* <View style={styles.PTransportList}> */}
        <View style={styles.route}>
        <Text style={styles.titleData}>{element.route}</Text>
        {/* </View> */}
        </View>
        ...
        <Text style={styles.list1} > {element.vehicleNo} </Text>
