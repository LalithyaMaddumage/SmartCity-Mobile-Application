...
import {AddPowerCut} from '../../../services/electricityService';

export default function AddPowerCutDetails(){
    ...
    const sendData = async()=>{
        ...
        let response = await AddPowerCut (newPowerCut);
