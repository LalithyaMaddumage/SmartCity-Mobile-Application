...
import {updateShedule, DeleteShedule} from '../../../services/electricityService';

export default function UpdatePowerCutDetails(props){
    console.log("update power cut details",props);
    ...
    const sendData = async()=>{
        ...
        let response = await updateShedule(props.data._id, updatePowerCut);
        console.log("data update",response);

        if(response.ok){
            ToastAndroid.show(

                'Power Cut Shedule Successfully Updated..', ToastAndroid.SHORT
              );
    ...
    const deletePowerCutShedule=async()=>{
        ...
        if(response.ok){
            ToastAndroid.show(
                ...
                'Power Cut Shedule Successfully Deleted..', ToastAndroid.SHORT
              );
    ...
    return(
        <View style={styles.centeredView}>
            <View style={styles.modalView}>
                ...
                <Text style={styles.stationName}>Power Cut - {Location} </Text>
