...
import UpdateWasteCenter from './updateWasteCenterDetails';
...
export default function viewWasteCenterDetails() {

    const [wastecenterList, setWasteCenterList] =useState([]);
    ...
    const onRefresh = React.useCallback(() => {
        ...
        getWasteCenter().then((res) => {



            if (res.ok) {

                setWasteCenterList(res.data);
...
const List = () => {
    ...
    return wastecenterList.map((element) => {
    return (
    ...
    <View style={[styles.itemList, styles.elevation]}>
        ...
        <Text style={styles.titleID}>{element.shopName}</Text>
        {/* <View style={styles.wastecenterList}> */}
        ...
        <Text style={styles.list}>Open Hours    </Text>
