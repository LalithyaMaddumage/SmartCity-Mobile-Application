...
import { updateWasteCenter ,DeleteWasteCenter} from '../../../services/wasteCenterService';

export default function UpdateWasteCenterDetails(props) {
    ...
    const sendData = async() =>{
        ...
        let response=await updateWasteCenter (props.data._id,newupdateWasteCenter );
...
const DeleteWasteCenterStation=async()=>{
    let response = await DeleteWasteCenter(props.data._id);
  ...
  return (
    <View style={styles.centeredView}>
        ...
        <View style={{ marginTop: 10 }} >
                    ...
                    <Text style={styles.selectText}>ShopName </Text>
                    ...
                    <TouchableHighlight underlayColor='none' style={styles.delbutton}
                       onPress={() => DeleteWasteCenterStation()
                     } >
