...
export default function viewWasteCenterdetailsCus(props) {
  ...
  return (
    <View style={styles.centeredView}>
        ...
        <Text style={styles.stationName}>{shopName} </Text>

                    {/* Fuel station Loaction  */}

                    <View style={styles.time1}>
                       
                       <Text style={styles.name2}>Location: </Text>
  
                       <Text style={styles.name3}>{location}</Text>
                          </View>
                     ...
                     <Text style={styles.name2}>Item Type: </Text>

                     <Text style={styles.name3}>{items}</Text>
                        </View>
