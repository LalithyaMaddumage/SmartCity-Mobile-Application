import {  View, Text , StyleSheet , TextInput ,SafeAreaView,Picker,Button ,Alert ,ScrollView, TouchableHighlight,ToastAndroid,ImageBackground,Dimensions} from 'react-native'
import React ,{useState} from 'react'
import SelectList from 'react-native-dropdown-select-list';
import { WasteCenterAdd } from '../../../services/wasteCenterService';

export default function AddWasteCenterDetails() {
    ...
    const sendData = async() =>{
        ...
        let response=await WasteCenterAdd (newWaste);
        ...
        if(response.ok){
            ToastAndroid.show(
                ...
                'Waste section Successfully Added..', ToastAndroid.SHORT
              );
    ...
    <ImageBackground source = { require('../../../assets/background3.png')} style={styles.body}> 
      ...
      <ScrollView>
                ...
                <Text style={styles.header}>
                    Waste Center Details
                 
                </Text>
               
               
                <Text style={styles.selectText}> Center Name:</Text>
                <TextInput style={styles.name} 
                    onChangeText={(e) => {setShopName(e)}} 
                    placeholder ="Waste Station Name"
                    required>
                ...
                <Text style={styles.selectText}> Description:</Text>
                    ...
                    <Text style={styles.selectText}> Item type:</Text>
                    <TextInput style={styles.name} 
                    onChangeText={(e) => {setItems(e)}} 
                    placeholder ="Plastic"
                    required>
                    ...
                    <Text style={styles.selectText}> Contact Number:</Text>
                    <TextInput style={styles.name} 
