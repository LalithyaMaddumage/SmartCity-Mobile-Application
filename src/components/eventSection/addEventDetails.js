...
import { EventAdd } from '../../../services/eventService';
...
const sendData = async() =>{
  ...
  let response =await EventAdd (newEvent);
  console.log("data add" , response);

  if (response.ok){
    ToastAndroid.show(
      'Event Successfully Added..' ,ToastAndroid.SHORT
    );
    ...
    <ScrollView>
              ...
              <SafeAreaView>
                  ...
                  required>
                   ...
                   <Text style={styles.selectText}>Loaction :</Text>
                  <SelectList  
