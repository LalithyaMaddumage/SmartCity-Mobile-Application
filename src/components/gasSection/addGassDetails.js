...
import { GasAdd } from '../../../services/gasService';
...
export default function AddGassDetails() {
    ...
    const sendData = async() =>{
        ...
        let response=await GasAdd (newGas);
        ...
        if(response.ok){
            ToastAndroid.show(
                ...
                'Gas Station Successfully Added..', ToastAndroid.SHORT
              );
    ...
    <View  style={styles.body}>
      ...
      <ScrollView>
                ...
                <SafeAreaView>
                    ...
                    <Text style={styles.selectText}> Available:</Text>
                    <SelectList  
                    boxStyles ={{borderColor:'blue', borderRadius:20,  width:300,
                    height: 45,
                    marginLeft: 12,
